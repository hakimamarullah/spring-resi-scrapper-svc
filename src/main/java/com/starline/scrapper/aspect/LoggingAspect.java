package com.starline.scrapper.aspect;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.starline.scrapper.config.LoggingContext;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(@com.starline.scrapper.annotations.LogRequestResponse * *(..))")
    public void methodWithLoggedRequestResponse() {
    }


    @Pointcut("within(@com.starline.scrapper.annotations.LogRequestResponse *)")
    public void classWithLogRequestResponse() {
    }

    @Pointcut("within(@com.starline.scrapper.annotations.LogResponse *)")
